"""
Django settings for red_bonus_40425 project.
...
ROOT_URLCONF = 'red_bonus_40425.urls'
...
WSGI_APPLICATION = 'red_bonus_40425.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_bonus_40425 API",
    "DESCRIPTION": "API documentation for red_bonus_40425 App",
    "VERSION": "v1",
}
